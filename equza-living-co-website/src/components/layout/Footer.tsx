      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-cream-300 text-sm leading-relaxed mb-6">
              ...
              Discover heritage weaving traditions reimagined for contemporary living.
            </p>
        ...
        <div className="border-t border-warm-800 mt-8 pt-8 flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap gap-6 text-sm">
            <Link href="/privacy" className="text-cream-400 hover:text-cream-50 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-cream-400 hover:text-cream-50 transition-colors">
              Terms of Service
            </Link>
            <Link href="/shipping" className="text-cream-400 hover:text-cream-50 transition-colors">
              Shipping Policy
            </Link>
          </div>
        </div>
