        ...
        {formState === 'success' ? (
          ...
          >
            ...
            <Typography variant='body1' className='text-stone-600'>
              Thank you for your interest in partnering with us. Our trade team
              will review your application and get back to you within 3 business
              days.
            </Typography>
          ...
          >
            ...
            <div className='text-center pt-4 border-t border-stone-200 space-y-2'>
              ...
              <div className='text-sm text-stone-500 space-y-1'>
                <div>
                  1. We'll review your application within 3 business days
                </div>
                <div>2. Schedule a call to discuss partnership details</div>
                <div>
                  3. Provide partnership agreement and wholesale pricing
                </div>
