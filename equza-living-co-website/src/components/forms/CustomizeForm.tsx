      ...
      <AnimatePresence mode='wait'>
        {formState === 'success' ? (
          ...
          >
            ...
            <Typography variant='body1' className='text-stone-600'>
              Thank you for your custom rug request. Our design team will review
              your requirements and get back to you within 2 business days.
            </Typography>
          ...
          >
                      ...
                      {FORMS.customize.materialOptions.map((material) => (
                        ...
                        >
                          <input
                            ...
                            onChange={() => {
                              const updated = handleMaterialToggle(
                                material,
                                field.value || []
                              );
            ...
            <div className='text-center pt-4 border-t border-stone-200 space-y-2'>
              <Typography variant='body2' className='text-stone-600'>
                Our design team will review your request and provide a detailed
                quote within 2 business days.
              </Typography>
              <Typography variant='caption' className='text-stone-500'>
                Custom rugs typically take 6-8 weeks to complete depending on
                complexity.
              </Typography>
            </div>
          </motion.form>
