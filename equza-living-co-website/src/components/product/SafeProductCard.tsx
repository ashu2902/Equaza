          ...
          <div className="aspect-square relative overflow-hidden">
            ...
            {product.isFeatured && (
              <div className="absolute top-3 left-3 z-10">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium text-white font-poppins" style={{ backgroundColor: '#98342d' }}>
                  Featured
                </span>
              </div>
            )}
        ...
        <div className="p-6">
          <div className="space-y-3">
            ...
            <Typography 
              ...
              style={{ color: '#9ca3af' }}
            >
              {product.specifications.weaveType} • {product.specifications.origin}
            </Typography>
            
            {/* Price */}
            {showPrice && product.price.isVisible && product.price.startingFrom > 0 && (
              <Typography 
                variant="body" 
