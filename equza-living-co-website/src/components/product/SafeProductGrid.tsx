    ...
    <div className={`space-y-8 ${className}`}>
      ...
      {title && (
        <div className="text-center space-y-3">
          <Typography variant="h2" className="font-libre-baskerville font-normal" style={{ color: '#98342d' }}>
            {title}
          </Typography>
          {subtitle && (
            <Typography variant="body" className="font-poppins max-w-2xl mx-auto" style={{ color: '#666666' }}>
              {subtitle}
            </Typography>
          )}
        </div>
