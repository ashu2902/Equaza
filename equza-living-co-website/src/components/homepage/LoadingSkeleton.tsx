...
interface LoadingSkeletonProps {
  variant: 'hero' | 'tiles' | 'mega-tiles' | 'banner' | 'story' | 'lookbook' | 'contact';
}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="space-y-4">
                    ...
                    <div className={`${skeletonClass} h-16 w-full rounded-xl`} />
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-20 bg-primary-900">
          <Container size="xl">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <div className={`bg-primary-700 animate-pulse rounded h-4 w-32`} />
                <div className="space-y-4">
                  <div className={`bg-primary-700 animate-pulse rounded h-12 w-full`} />
                  <div className={`bg-primary-700 animate-pulse rounded h-12 w-3/4`} />
                  <div className={`bg-primary-700 animate-pulse rounded h-6 w-2/3`} />
                </div>
                <div className="space-y-6">
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div key={i} className="flex space-x-4">
                      <div className={`bg-primary-700 animate-pulse rounded-full w-12 h-12`} />
                      <div className="space-y-2 flex-1">
                        <div className={`bg-primary-700 animate-pulse rounded h-4 w-1/3`} />
                        <div className={`bg-primary-700 animate-pulse rounded h-3 w-2/3`} />
                      </div>
                    </div>
                  ))}
                </div>
              </div>
              <div className={`bg-primary-700 animate-pulse rounded-2xl h-96 w-full`} />
            </div>
          </Container>
        </section>
      );
                ...
                <div className="grid grid-cols-2 gap-6">
                  {Array.from({ length: 4 }).map((_, i) => (
                    <div key={i} className="text-center space-y-3">
                      <div className={`${skeletonClass} w-12 h-12 rounded-full mx-auto`} />
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div key={i} className="flex space-x-4">
                      <div className={`bg-primary-700 animate-pulse rounded-full w-10 h-10`} />
                      <div className="space-y-2 flex-1">
                        <div className={`bg-primary-700 animate-pulse rounded h-4 w-1/3`} />
                        <div className={`bg-primary-700 animate-pulse rounded h-3 w-2/3`} />
                      </div>
                ...
                <div className={`bg-primary-700 animate-pulse rounded h-12 w-48`} />
              </div>
              <div className={`bg-primary-700 animate-pulse rounded-2xl h-96 w-full`} />
            </div>
          </Container>
          ...
          <Container size="xl">
            <div className="space-y-16">
              ...
              <div className="grid lg:grid-cols-2 gap-16">
                <div className="space-y-6">
                  {Array.from({ length: 3 }).map((_, i) => (
                    <div key={i} className={`${skeletonClass} h-24 w-full rounded-xl`} />
                  ))}
                  <div className={`${skeletonClass} h-32 w-full rounded-xl`} />
                </div>
