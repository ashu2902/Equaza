    ...
    <SlideUp delay={index * 0.1}>
      ...
      >
        <div className='relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2'>
            ...
            <div className='absolute inset-0 p-6 flex flex-col justify-end text-white'>
              <div className='space-y-3'>
                ...
                <div className='flex items-center justify-between pt-2'>
                  ...
                  <div
                    className={`flex items-center space-x-1 transform transition-transform duration-300 ${
          ...
          {/* Hover Effect Border */}
          <div
            className={`absolute inset-0 border-2 border-primary-500 rounded-xl transition-opacity duration-300 ${
