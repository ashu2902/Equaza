        ...
        <div className='relative bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3'>
            ...
            <div className='absolute inset-0 p-8 flex flex-col justify-end text-white'>
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between pt-4 border-t border-white/20'>
                  ...
                  <div
                    className={`flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 transition-all duration-300 ${
          ...
          <div className='p-6 bg-white'>
            <div className='flex items-center justify-between'>
              ...
              <div
                className={`p-3 bg-primary-50 rounded-full transition-all duration-300 ${
          ...
          {/* Hover Effect Border */}
          <div
            className={`absolute inset-0 border-3 border-primary-500 rounded-2xl transition-opacity duration-300 ${
