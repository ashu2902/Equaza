          ...
          <div className='space-y-8'>
                ...
                {lookbook ? (
                  <div className='space-y-4'>
                    <Typography
                      ...
                      style={{ color: '#4b5563' }}
                    >
                      Explore our {lookbook.version} collection featuring 50+
                      pages of stunning rug designs, room inspirations, and
                      style guides.
                    </Typography>
                  ...
                  >
                    ...
                    room inspirations, and expert styling tips in our
            ...
            <SlideUp delay={0.2}>
              <div className='space-y-6'>
                <Typography
                  variant='h4'
                  className='font-medium font-libre-baskerville'
                  style={{ color: '#98342d' }}
                >
                  What's Inside:
                </Typography>
        ...
        <Container size='xl' className='relative z-10 mt-16'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8 text-center'>
            <div className='space-y-2'>
              <Typography
                variant='h4'
                className='text-2xl font-light font-libre-baskerville'
                style={{ color: '#98342d' }}
              >
                10K+
              </Typography>
