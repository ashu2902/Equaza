...
export function SafeCollectionTile({ 
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative bg-white overflow-hidden transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02]" 
             style={{ 
               borderRadius: '16px',
          ...
          <div className="relative h-80 lg:h-96 bg-gray-100 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
              <div className="space-y-3 text-white">
                ...
                <div 
                  className="inline-flex items-center text-white font-medium text-sm mt-4 drop-shadow-md transition-all duration-300 hover:translate-x-1 font-poppins"
                >
