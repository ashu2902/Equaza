            ...
            >
                ...
                {showProductCount && displayProductCount > 0 && (
                  <div className='flex items-center gap-2'>
                    <Typography variant='body1' className='text-white/80'>
                      {displayProductCount}{' '}
                      {displayProductCount === 1 ? 'piece' : 'pieces'} in this
                      collection
                    </Typography>
                  </div>
                )}
              ...
              >
                <Typography variant='body2' className='text-white/70'>
                  Each piece in this collection is handcrafted with attention to
                  detail and represents the finest in traditional artistry.
                </Typography>
              </motion.div>
            </motion.div>
          </div>
