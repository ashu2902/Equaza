...
export const metadata: Metadata = {
  ...
  description:
    'Create your perfect custom rug with Equza Living Co. Choose your size, materials, colors, and design. Our skilled artisans will bring your vision to life.',
  openGraph: {
...
const customizationFeatures = [
  {
    ...
    description:
      'Choose from hundreds of colors and create unique patterns that reflect your style',
  },
  {
    icon: Ruler,
    title: 'Custom Sizes',
    description:
      'Any size you need, perfectly crafted to fit your space and requirements',
  },
  {
    icon: Heart,
    title: 'Personal Touch',
    description:
      'Add meaningful symbols, motifs, or family elements to make it truly yours',
  },
];
...
const processSteps = [
  {
    ...
    description:
      'Tell us about your dream rug through our detailed form and inspiration uploads',
  },
  {
    step: '02',
    title: 'Design Consultation',
    description:
      'Our experts work with you to refine the design and select perfect materials',
  },
  {
    step: '03',
    title: 'Masterful Creation',
    description:
      'Skilled artisans handcraft your rug using traditional techniques and premium materials',
  },
  {
    step: '04',
    title: 'Delivered to You',
    description:
      'Your unique masterpiece is carefully packaged and delivered to your door',
  },
];
    ...
    <ErrorBoundary>
      <div className='min-h-screen' style={{ backgroundColor: '#f1eee9' }}>
        <section className='py-6 border-b border-gray-200'>
          <Container size='lg'>
            <Breadcrumbs
              items={[{ label: 'Home', href: '/' }, { label: 'Customize' }]}
            />
          </Container>
        </section>
        {/* Hero Section */}
              ...
              <SlideUp delay={0.4}>
                <div className='max-w-6xl mx-auto'>
                  <div className='mb-16'>
                    ...
                    >
                      Every aspect of your rug can be customized to create
                ...
                <div className='max-w-6xl mx-auto'>
                  <div className='mb-12'>
                    ...
                    <Typography
                      ...
                      style={{ fontFamily: 'Poppins' }}
                    >
                      Share your vision with us and let our artisans create
