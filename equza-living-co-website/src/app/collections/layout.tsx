...
export const metadata: Metadata = {
  ...
  description:
    'Explore our curated rug collections organized by style and space. From contemporary to traditional designs, find the perfect handcrafted rug for your home.',
  openGraph: {
