...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      ...
      `Explore the ${collection.name} collection of handcrafted rugs from Equza Living Co.`,
    openGraph: {
      title: `${collection.name} Collection | Equza Living Co.`,
      description:
        collection.description ||
        `Handcrafted rugs from the ${collection.name} collection`,
      images: collection.heroImage
        ? [collection.heroImage.url]
        : ['/images/og-collection.jpg'],
    },
  };
}
                ...
                <SlideUp delay={0.2}>
                  <div className='mb-8 text-center'>
                    ...
                    <Typography
                      ...
                      align='center'
                    >
                      {products.length} handcrafted rugs featuring unique
