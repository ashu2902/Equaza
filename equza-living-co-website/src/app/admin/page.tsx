          ...
          <Card className='bg-white border-[#98342d]/20 hover:shadow-lg transition-shadow'>
            <CardContent className='p-6'>
              ...
              <div className='flex items-center mt-4'>
                ...
                <span className='text-sm text-[#98342d]/50 ml-1'>
                  vs last month
                </span>
              </div>
            </CardContent>
      ...
      <CardHeader>
        <CardTitle className='flex items-center justify-between text-[#98342d]'>
          ...
          <Button
            ...
            size='sm'
            asChild
            className='border-[#98342d]/30 text-[#98342d] hover:bg-[#98342d]/10'
          >
      ...
      <CardContent>
        <div className='space-y-4'>
          {activities.map((activity, index) => (
            <div
              key={index}
              className='flex items-start space-x-3 p-3 rounded-lg hover:bg-[#98342d]/5 transition-colors'
            >
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-[#98342d]/70'>
                  Manage your Equza Living Co. website content and monitor key
                  metrics
                </p>
              </div>
              <div className='hidden sm:block'>
                <Button
                  asChild
                  className='bg-[#98342d] hover:bg-[#98342d]/90 text-white'
                >
                  <Link href='/'>
